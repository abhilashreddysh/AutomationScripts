...
cpucores=subprocess.check_output('grep -ioP \'processor\t:\' /proc/cpuinfo | wc -l',shell=True,text=True)
cpuname=subprocess.check_output('grep "model name" /proc/cpuinfo | cut -d \' \' -f3- | head -1',shell=True,text=True)
